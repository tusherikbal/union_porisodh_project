        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              ...
              <div class="thismargin px-5 p-1">

                <div class="d-flexd">
                    <div class="h3 text-center mb-5">View Collector info
                    </div>
                      ...
                      <table class="table table-hover table-bordered">
                        <tr>
                         <th scope="col">Name</td>
                          <td scope="col">Tusher Ikbal</td>
                        </tr>

                        <tr>
                          <th scope="col">Fathers Name</th>
                          <td scope="col">Shahid Ullah</td>
                        </tr>

                        <tr>
                          <th scope="col">User name</th>
                          <td scope="col">tusherikbal</td>
                        </tr>

                        <tr>
                          <th scope="col">Password</th>
                          <td scope="col">tusherikbal1234</td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td scope="col">
                            ...
                            <button type="button" class="btn btn-warning btn-sm" onclick="alert()">Edit Info</button>

                            <button type="button" class="btn btn-success btn-sm" >Go to Admin</button>
                          </td>
                        </tr>
